...
def main():
    ...
    import os
    files_dir = "/home/vaibhav-mishra/projects/Time_extraction/files"
    tests_dir = os.path.join(files_dir, "tests")
    test_script = os.path.join(tests_dir, "test_orchestrator.py")
    python_bin = f"{files_dir}/venv/bin/python3"
    
    print(f"\n📂 Running from: {tests_dir}")
